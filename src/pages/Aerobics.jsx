...
import aerobicsClassImg from '../assets/aerobics_class.jpg';
import './Studios.css';
      ...
      <section className="section studio-pricing">
        <div className="container studio-pricing__container-grid">
          ...
          <div className="studio-pricing__image-wrapper brutal-card">
            <img src={aerobicsClassImg} alt="Darur Life Studio — Aerobics Class Session" className="studio-pricing__image" />
          </div>
        </div>
      </section>
